...
{
public const FIELD_NUMBER_OF_DOORS = 'numberOfDoors';
public const FIELD_NUMBER_OF_SEATS = 'numberOfSeats';
public const FIELD_CARGO_CAPACITY = 'cargoCapacity';

protected string $type = "Bodywork";
...
* @return $this
*/
public function setCargoCapacity (?\Pimcore\Model\DataObject\Data\QuantityValue $cargoCapacity): static
{
